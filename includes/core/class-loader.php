...
class ATTRLA_Loader {
    ...
    /**
     * Remove all actions and filters registered by this loader.
     * Useful for cleanup during deactivation or uninstallation.
     */
    public function remove_all_hooks() {
        ...
        // Remove shortcodes
        foreach ($this->shortcodes as $shortcode) {
            remove_shortcode($shortcode['hook']);
        }
    }
     ...
     *
     * @return array Array containing all registered hooks.
     */
